...
/*
 Copyright 2014 - 2014 BanSharp
 Interrupter.cs is part of BanSharp.Common.
...
namespace Zileanz
{
    ...
    public static class Interrupt
    {
        ...
        {
            foreach (var enemy in ObjectManager.Get<Obj_AI_Base>().Where(e => e.IsValidTarget()))
            {
        ...
        /// <param name="unit">The unit.</param>
        /// <returns></returns>
        public static bool IsChannelingImportantSpell(this Obj_AI_Base unit)
        {
            return
                Spells.Any(
                    spell =>
                        spell.ChampionName == unit.BaseSkinName &&
